...
function solveQuestion(index: number, values: number[]): Record<string, number> {
  switch (index) {
    ...
    case 2:
      return solve_q2(values[0], values[1], values[2], values[3]);
    case 3:
      return solve_q3(values[0], values[1], values[2]);
    case 4:
      return solve_q4(values[0], values[1], values[2], values[3]);
    case 5:
      return solve_q5(values[0], values[1], values[2], values[3], values[4]);
    case 6:
      return solve_q6(values[0], values[1]);
    case 7:
      return solve_q7(values[0], values[1], values[2]);
    case 8:
      return solve_q8(values[0], values[1]);
    case 9:
      return solve_q9(values[0], values[1], values[2], values[3], values[4], values[5]);
    default:
      return {};
  }
}
